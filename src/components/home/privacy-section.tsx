...
const POINTS = [
  ...
  },
  {
    ...
    description:
      "Only the tools marked Available process documents — merging, splitting, extracting, deleting, reordering and rotating pages today. Every other tool says plainly that it is not built yet, instead of implying capabilities we do not have.",
  },
];
