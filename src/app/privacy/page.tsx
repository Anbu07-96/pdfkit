  ...
  return (
    ...
    >
      <Prose>
        ...
        <ul>
          <li>
            The four working tools — <strong>Merge PDF</strong>,{" "}
            <strong>Split PDF</strong>, <strong>Extract PDF Pages</strong> and{" "}
            <strong>Delete PDF Pages</strong> — are the only ones that send data
            anywhere. When you start the operation, the selected files are uploaded to
            the PDFKit server, processed in memory and returned in the response. The
            page tools also read the page count the same way.
          </li>
          <li>
