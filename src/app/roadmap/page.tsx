...
const PHASES = [
  ...
  {
    title: "Phase 2 — First real PDF processing",
    status: "Planned" as const,
    items: [
      "Server-side processing layer behind an API route",
      "A first working tool end to end, marked Available only when it works",
      "Real progress, result and error handling",
      "Temporary file lifecycle with automatic deletion",
    ],
  },
  {
    title: "Later phases",
