...
const HTTP_STATUS: Record<ProcessingErrorCode, number> = {
  ...
  INVALID_IMAGE: 422,
  ENCRYPTED_PDF: 422,
  PDF_NOT_ENCRYPTED: 422,
  WRONG_PASSWORD: 422,
  UNSUPPORTED_ENCRYPTION: 422,
  SIGNED_PDF: 422,
  INVALID_SPLIT_CONFIGURATION: 400,
  INVALID_PAGE_RANGE: 400,
  PAGE_OUT_OF_RANGE: 400,
  OVERLAPPING_RANGES: 400,
  INVALID_PAGE_ORDER: 400,
  INVALID_PAGE_ROTATION: 400,
  INVALID_WATERMARK_CONFIGURATION: 400,
  INVALID_PAGE_NUMBER_CONFIGURATION: 400,
  INVALID_CROP_CONFIGURATION: 400,
  INVALID_TEXT_CONFIGURATION: 400,
  INVALID_SHAPE_CONFIGURATION: 400,
  INVALID_HIGHLIGHT_CONFIGURATION: 400,
  INVALID_DRAW_CONFIGURATION: 400,
  INVALID_ANNOTATION_CONFIGURATION: 400,
  NO_PAGES_REMAIN: 400,
